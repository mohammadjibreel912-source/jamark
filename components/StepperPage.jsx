...
const StepperPage = () => {
  ...
  // في المكون الأب (حيث يتم تعريف حالات الخطوات)
  ...
  return (
    ...
    >
      ...
      <div className="content-wrapper" style={{ flex: 1 }}>
        ...
        {step === 3 && (
          <Step3 // 🛑 CHANGE 1: Use the correct component name (Step3Company)
            companyName={companyName}
            setCompanyName={setCompanyName}
            // You can remove activityId/setActivityId if you're only using companyActivities
            // activityId={activityId}
            // setActivityId={setActivityId}

            // 🚀 CHANGE 2: Pass the state array (companyActivities) to the child component
            companyActivities={companyActivities}
            setCompanyActivities={setCompanyActivities} // Keep the setter function
            companyType={companyType}
            setCompanyType={setCompanyType}
            companyForm={companyForm}
            setCompanyForm={setCompanyForm}
            managementMethod={managementMethod}
            setManagementMethod={setManagementMethod}
            managerName={managerName}
            setManagerName={setManagerName}
            activities={activities} // This prop seems unused in the final Step3Company but can remain if needed elsewhere
            // Lookup data props
        ...
        {step === 4 && (
          <Step4
            ...
            language={language}
            establishmentAddress={establishmentAddress}
            setEstablishmentAddress={setEstablishmentAddress}
            establishmentLocation={establishmentLocation}
            setEstablishmentLocation={setEstablishmentLocation}
            foundingYear={foundingYear}
            ...
            setNotes={setNotes}
            factoryProducts={factoryProducts}
            setFactoryProducts={setFactoryProducts}
            companyActivities={companyActivities}
            setCompanyActivities={setCompanyActivities} // إذا كانت Step 4 تستخدمها
          />
        )}
