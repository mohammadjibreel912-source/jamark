...
const WelcomePage = () => {
  ...
  return (
    <>
      {/* 1. Dynamic Logo Positioning based on language */}
     <img src={logoImg} alt="Logo" className={`logo ${isArabic ? 'logo-ar' : 'logo-en'}`} />
      {/* Placeholder for LanguageSwitcher, placed outside the main wrapper for global access */}
      <div className="language-switcher-wrapper">
         <LanguageSwitcher />
      </div>

      {/* 2. Global Direction (dir) set here */}
          ...
          <div className="mini-cards-wrapper">
            ...
            <div className="mini-card">
              ...
              <div className="section">
                ...
                <ul className="list-content"> {/* Added class for consistent styling */}
